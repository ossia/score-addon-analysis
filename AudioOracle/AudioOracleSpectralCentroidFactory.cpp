#include "AudioOracleSpectralCentroidFactory.hpp"
...
{
  return QObject::tr("Audio Oracle - Spectral Centroid");
}
...

{
  ...
  progress.open();
  //... copy one file
  audio_oracle.AnalyseAudio(fileName, 32768, "spectralCentroid", 0.08);
